task8, expressions analysis
===========================

task8 it`s a PHP CLI script, that parses and evaluates mathematical expressions with parentheses.

task8 works with PHP 5.6 or later.
