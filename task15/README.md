task15, HTML-page parsing
=========================

task15 it`s a PHP CLI script, that reads the HTML page (with the real site) and download to your local directory all images that are displayed on it.

task15 works with PHP 5.6 or later.
