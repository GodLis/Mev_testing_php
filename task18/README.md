task18, chat server console
===========================

task18 it`s a PHP CLI script, that implement a simple console chat server with using sockets.

task18 works with PHP 5.6 or later.
