task14, working with files in the deployed directory
====================================================

task14 it`s a PHP CLI script, that displays a list of the all files in the given directory in the form of deployed tree.

task14 works with PHP 5.6 or later.
